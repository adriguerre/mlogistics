...
public class InventoryController {
    ...
    @GetMapping
    public ResponseEntity<Page<Inventory>> getAll(@PageableDefault(size = 20) Pageable pageable) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable UUID id, @RequestBody Inventory entity) {
